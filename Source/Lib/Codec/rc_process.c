...
void *svt_aom_rate_control_kernel(void *input_ptr) {
    ...
    for (;;) {
        ...
        case RC_INPUT:
            ...
            if ((pcs->scs->static_config.tune == 2 || pcs->scs->static_config.tune == 3
                || pcs->ppcs->scs->static_config.tune == 4 || pcs->ppcs->scs->static_config.tune == 5) && !pcs->ppcs->frm_hdr.delta_q_params.delta_q_present) {
