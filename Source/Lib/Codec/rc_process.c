        ...
        case RC_INPUT:
            ...
            if (pcs->ppcs->is_overlay) {
                ...
                if (scs->static_config.rate_control_mode == SVT_AV1_RC_MODE_CQP_OR_CRF) {
                    ...
                    int32_t chroma_delta_q = chroma_qindex - frm_hdr->quantization_params.base_q_idx;
                    chroma_qindex = frm_hdr->quantization_params.base_q_idx + CLIP3(-64, 63, chroma_delta_q);
                    ...
                    //SVT_LOG("I was here %i %i\n", chroma_qindex, frm_hdr->quantization_params.delta_q_dc[1]);
